...
export default function OnboardingPage() {
  ...
  return (
    <div className="max-w-lg">
      <h1 className="text-2xl font-semibold text-zinc-900">Unternehmen anlegen</h1>
      <p className="mt-2 text-zinc-600">
        Erstelle dein Unternehmensprofil, um das Seniorenfreundlich-Siegel zu beantragen.
      </p>
      ...
      <form action={action} className="mt-8 space-y-6">
        ...
        <div>
          <label htmlFor="slug" className="block text-sm font-medium text-zinc-700">
            Slug (URL-Kennung) <span className="text-red-500">*</span>
          </label>
        ...
        >
          {pending ? "Wird erstellt…" : "Unternehmen anlegen"}
        </button>
      </form>
    </div>
  );
